...
princp=[]
try:
	prox= requests.get('https://github.com/Pro-Max-420/Api/blob/AKAS/prox.txt').text
...
while attemps < 12345677901:
    ...
    if username == 'AKAS' and password == 'H':
...
        
  ...
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO OGM  X AKAS   FIRE (🥰)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [ 1.1 ] FIRE (😻)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
